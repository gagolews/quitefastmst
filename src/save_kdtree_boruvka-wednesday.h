...
protected:
    ...
    void find_mst()
    {
        ...
        while (ds.get_k() != 1) {
            ...
            QUITEFASTMST_ASSERT(ds_k == ds.get_k());
            ...
            QUITEFASTMST_PROFILER_START
            update_cluster_data();
            QUITEFASTMST_PROFILER_STOP("update_cluster_data")

            // set up cluster_repr and reset max_ncl_dist
            QUITEFASTMST_PROFILER_START
            update_node_data();
            QUITEFASTMST_PROFILER_STOP("update_node_data")
